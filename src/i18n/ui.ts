...
export const ui: Record<Lang, Copy> = {
  en: {
    ...
    availability: 'Currently supports accounts hosted by Bluesky, including custom domain handles. App interface languages: English and Simplified Chinese. Distribution is planned outside China mainland, including Japan.',
  ...
  zh: {
    ...
    availability: '当前支持由 Bluesky 托管的账户，包括使用自定义域名 handle 的账户。应用界面支持英语和简体中文。计划在中国大陆以外地区提供，包括日本。',
  ...
  ja: {
    ...
    availability: '現在は Bluesky がホストするアカウントに対応し、独自ドメインのハンドルも利用できます。アプリの表示言語は英語と簡体字中国語です。中国本土を除く地域での配信を予定しており、日本も含まれます。',
